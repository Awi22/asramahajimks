...
/**
 * Simple Datatables Library, cukup query, filter dan search berfungsi
 * Manual cek di https://github.com/zdienos/codeigniter3-datatables
 * Kekurangan : Tidak bisa custom output, pake punyanya Gaza saja
 */
