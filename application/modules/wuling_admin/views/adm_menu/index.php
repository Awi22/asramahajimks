	...
	<div id="kt_app_toolbar" class="app-toolbar py-3">
		<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
			...
			<div class="d-flex align-items-center gap-2 gap-lg-3">
				<!-- <button href="<?=base_url()?>wuling_adm_menugroup/add" type="button" name="btn-tambah" id="btn-tambah" class="btn btn-sm fw-bold btn-primary" >Tambah Group Menu</button> -->
			</div>
		</div>
	</div>
	<!--end::Toolbar-->
				...
				<div class="flex-column flex-lg-row-auto w-100 w-xl-250px mb-10">
					<div class="card mb-5 mb-xl-8">
						<div class="container-fluid d-flex flex-stack p-4">
							...
							<div class="d-flex align-items-center  ">
								<button href="<?=base_url()?>wuling_adm_menugroup/add" type="button" name="btn-tambah" id="btn-tambah" class="btn btn-sm fw-bold btn-primary"> + </button>
							</div>
						</div>
					...
					<div class="card mb-5 mb-xl-8">
						...
						<div class="card-body pt-5 pb-2">
							<form id="form-add-menu" method="post" action="<?= site_url('wuling_adm_menu/add'); ?>">
					...
					<div class="card mb-5 mb-xl-8">
						...
						<div class="card-body p-4">
							<div id="main" class="col">
								<div class="mb-5 hover-scroll-x">
									<div class="d-grid">
										...
										<li id="group-<?= $menu->id; ?>" class="nav-item">
											<?php if ($menu->id=='1'){ ?>
												<a href="<?= site_url('wuling_adm_menu'); ?>" class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0">
													<?= $menu->title; ?>
												</a>
											<?php } else { ?>
												
												<a href="<?= site_url('wuling_adm_menu/menu'); ?>/<?= $menu->id; ?>" class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-primary rounded-bottom-0">
													<?= $menu->title; ?>
												</a>
											<?php } ?>
										</li>
								...
								<form method="post" id="form-menu" action="<?= site_url('wuling_adm_menu/save_position'); ?>">
