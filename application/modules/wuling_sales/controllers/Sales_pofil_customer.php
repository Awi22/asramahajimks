...
class Sales_pofil_customer extends MY_Controller
{
    ...
    public function getDataCustomer()
    {
        ...
        $data = $this->Model_customer->getDataCustomer($post['tahun'], $post['bulan'], $post['status'],  $post['source'], $this->id_sales);
        responseJson(['aaData' => $data]);
    }


    //** Data Tambah  Customer */

    public function getDataProvinsi()
    {
        $id_provinsi = $this->input->post('id_provinsi');
        $data = $this->Model_customer->getDataProvinsi($id_provinsi);
        responseJson($data);
    }
    ...
    public function getDataKabupaten()
    {
        ...
        $data = $this->Model_customer->getDataKabupaten($id_provinsi, $id_kabupaten);
        responseJson($data);
    }
    ...
    public function getDataKecamatan()
    {
        ...
        $data = $this->Model_customer->getDataKecamatan($id_kabupaten, $id_kecamatan);
        responseJson($data);
    }
    ...
    public function getDataKelurahan()
    {
        ...
        $data = $this->Model_customer->getDataKelurahan($id_kecamatan, $id_kelurahaan);
        responseJson($data);
    }
    ...
    public function getDataSumberProspek()
    {
        ...
        $data = $this->Model_customer->getDataSumberProspek($id_sumber_prospek);
        responseJson($data);
    }
    ...
    public function getDataAktivitas()
    {
        ...
        $data = $this->Model_customer->getDataAktivitas($id_sumber_prospek, $this->id_perusahaan, $tgl_aktivitas, $id_aktivitas);
        responseJson($data);
    }
    ...
    public function simpanDataCustomer()
    {
        ...
        try {
            ...
            $sumber_prospek = $post['opt_sumber_prospek'];
            if ($sumber_prospek == '1' || $sumber_prospek == '3' || $sumber_prospek == '11' || $sumber_prospek == '13' || $sumber_prospek == '14' || $sumber_prospek == '16' || $sumber_prospek == '17') {
                $customerSumberProspek = [
                    'tgl_event'         => $post['tgl_aktivitas'],
                    'id_event'          => $post['opt_aktivitas'],
                ...
                $customerSumberProspek = [
                    ...
                    'nama_agent'        => null,
                    'telepon_agent'     => null,
                    'id_sales_digital'  => $post['opt_sales_digital'],
                ];
                ...
                $customerSumberProspek = [
                    ...
                    'id_event'               => null,
                    'tgl_telpon_masuk'       => null,
                    'nama_stnk'              => $post['nama_stnk_sumber'],
                    'no_rangka_repeat_order' => $post['norak_sumber_prospek'],
                    'tgl_pembelian'          => null,
                    'tgl_walk_in'            => null,
                    'nama_agent'             => null,
                    'telepon_agent'          => null,
                ...
                $customerSumberProspek = [
                    ...
                    'telepon_agent'    => '',
                    'id_sales_digital' => '',
                    'nama_refrensi'    => $post['nama_refrensi'],
                    'tlpn_refrensi'    => $post['tlpn_refrensi'],
                ];
            }
            ...
            $customer = [
                ...
                'id_sumber_prospek' => $post['opt_sumber_prospek'],
                'keterangan'        => $post['ket_tambah'],
                'id_cus_digital'    => $post['digital_customer'],
                'sales'             => $this->id_sales,
                'type_customer'     => 'r',
            ];
            // debug(array_merge($customer, $customerSumberProspek));
            $setCustomer = array_merge($customer, $customerSumberProspek);
    ...
    public function getDataSuspect()
    {
        ...
        $data = $this->Model_customer->getDataSuspect($id_prospek);
        responseJson($data);
    }
    ...
    public function simpanDataSuspect()
    {
        ...
        try {
            ...
            if (empty($post['digital_customer'])) {
                ...
                $dataXylo = $this->Model_customer->getDataXyloWsa($post['digital_customer']);
                $setDataWsaSuspect = [
                    'id_prospek'        => $post['id_prospek_suspect'],
    ...
    public function getDataFormWsa()
    {
        ...
        $data =  $this->Model_customer->getDataFormWsa($form_id);
        responseJson($data);
    }
    ...
    public function getOccupationsWsa()
    {
        ...
        $data =  $this->Model_customer->getOccupationsWsa($occupation_id);
        responseJson($data);
    }
    ...
    public function getCannelsWsa()
    {
        ...
        $data =  $this->Model_customer->getCannelsWsa($channel_id);
        responseJson($data);
    }
    ...
    public function getNasonalEventWsa()
    {
        ...
        $data =  $this->Model_customer->getNasonalEventWsa($national_event_id);
        responseJson($data);
    }
    ...
    public function getDataDealer()
    {
        ...
        $data =  $this->Model_customer->getDataDealer($dealer_id, $this->id_perusahaan);
        responseJson($data);
    }

    public function getDataStatusFu()
    {
        $data =  $this->Model_customer->getDataStatusFu();
        responseJson($data);
    }

    public function getDataRemaksFu()
    {
        $data =  $this->Model_customer->getDataRemaksFu();
        responseJson($data);
    }

    public function getDataNextFu()
    {
        $data =  $this->Model_customer->getDataNextFu();
        responseJson($data);
    }
    ...
    {
        $id_prospek = $this->input->post('id_prospek');
        $data =  $this->Model_customer->cekDataProsepkIdWsa($id_prospek);
    ...
    {
        $data =  $this->Model_customer->getDataTypeUnit();
        responseJson($data);
    }
    ...
    public function getDataVarian()
    {
        ...
        $data =  $this->Model_customer->getDataVarian($id_type);
        responseJson($data);
    }
    ...
    {
        $id_prospek = $this->input->post('id_prospek');
        $data = $this->Model_customer->getDataProspek($id_prospek);
        responseJson($data);
    }
    ...
    public function getDataMediaMotivaor()
    {
        ...
        $data =  $this->Model_customer->getDataMediaMotivaor($id_media);
        responseJson($data);
    }
    ...
    {
        $kode_unit = $this->input->post('kode_unit');
        $data =  $this->Model_customer->getDataStockUnit($kode_unit);
        responseJson($data);
    }
    ...
    {
        $id_prospek = $this->input->post('id_prospek');
        $data = $this->Model_customer->getDataHotProspek($id_prospek);
        responseJson($data);
    }
    ...
    public function simpanHotProspek()
    {
        ...
        $cekProspekIdWsa =  $this->Model_customer->cekDataProsepkIdWsa($post['id_prospek_hot_prospek']);
        // dd($cekProspekIdWsa);
    ...
    {
        $id_prospek = $this->input->post('id_prospek');
        $data = $this->Model_customer->getDataSpk($id_prospek);
        responseJson($data);
    }
    ...
    public function getDataNoSpk()
    {
        ...
        $data = $this->Model_customer->getDataNoSpk($no_spk, $this->id_sales);
        responseJson($data);
    }
    ...
    public function getDataLeasing()
    {
        ...
        $data = $this->Model_customer->getDataLeasing($id_leasing);
        responseJson($data);
    }
    ...
    public function simpanSpk()
    {
        ...
        $cekProspekIdWsa =  $this->Model_customer->cekDataProsepkIdWsa($post['id_prospek_spk']);
        if (!empty($cekProspekIdWsa->prospect_id) == '' || !empty($cekProspekIdWsa->prospect_id) == null && !empty($cekProspekIdWsa->dealer_id) == '' || !empty($cekProspekIdWsa->dealer_id) == null && !empty($cekProspekIdWsa->salesman_id) == '' || !empty($cekProspekIdWsa->salesman_id) == null) {
            responseJson(
                [
                    'status' => false,
