<script>
    $(document).ready(function() {
        ...
        $('#tgl_awal').on('change', function() {
            TableJadwalKunjungan.ajax.reload();
        })
        ...
        TableJadwalKunjungan = $('#table_jadwal_kunjungan').DataTable({
            processing: true,
            order: [],
            autoWidth: false,
            ajax: {
                type: 'POST',
                url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataJadwalKunjungan",
                data: function(data) {
...

                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        var gembok = `<td class="text-end">
								...
								<button class="btn btn-icon btn-light-primary w-30px h-30px btn-fu" data-id_prospek="${full.id_prospek}" title="Follow Up">
            ...
            initComplete: function(settings, json) {
                $("#table_jadwal_kunjungan").wrap("<div style='overflow:auto; width:100%;position:relative;'></div>");
            },
    ...
    $(document).on('click', '.btn-fu', function() {
        var id_prospek = $(this).data('id_prospek');
        $('#modal_fu').modal('show');
        $('#id_prospek_fu').val(id_prospek);
        getStatusFu();
        getRemaksFu();
        getNextFu();
    });
    ...
    function getProvinsi(id_provinsi) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataProvinsi",
            data: {
    ...
    function getKabupaten(id_provinsi, id_kabupaten) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataKabupaten",
            data: {
                id_provinsi: id_provinsi,
    ...
    function getKacamatan(id_kabupaten, id_kecamatan) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataKecamatan",
            data: {
                id_kabupaten: id_kabupaten,
    ...
    function getKelurahan(id_kecamatan, id_kelurahan) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataKelurahan",
            data: {
                id_kecamatan: id_kecamatan,
    ...
    function getUnit(kode_unit) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataUnit",
            data: {
                kode_unit: kode_unit,
            },
            dataType: "json",
    ...
    function getSumberProspek(id_sumber_prospek) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataSumberProspek",
            data: {
    ...
    function getAktivitas(id_sumber_prospek, tgl_aktivitas, id_aktivitas) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataAktivitas",
            data: {
                id_sumber_prospek: id_sumber_prospek,
    ...
    function getSuspect(id_prospek) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataSuspect",
            data: {
    ...
    function getFormWsa(form_id) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataFormWsa",
            data: {
                form_id: form_id,
            },
            dataType: "json",
    ...
    function getOccupationsWsa(occupation_id) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getOccupationsWsa",
            data: {
    ...
    function getCannelsWsa(channel_id) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getCannelsWsa",
            data: {
    ...
    function getNasonalEventWsa(national_event_id) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getNasonalEventWsa",
            data: {
    ...
    function getDealer(dealer_id) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataDealer",
            data: {
                dealer_id: dealer_id
            },
            dataType: "json",
    ...
    $(document).on('click', '#btn_lanjut_suspect', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanProsesLanjutTahapan",
            data: {
    ...
    function getStatusFu() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataStatusFu",
            dataType: "json",
            success: function(data) {
                $('#status_fu').select2({
    ...
    function getRemaksFu() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataRemaksFu",
            dataType: "json",
            success: function(data) {
                $('#remaks_fu').select2({
    ...
    function getNextFu() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataNextFu",
            dataType: "json",
            success: function(data) {
                $('#next_fu').select2({
    ...
    $(document).on('click', '#btn_simpan_fu', function() {
        ...
        if (status_customer == 'suspect') {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanDataSuspect",
                data: {
                    ...formDataSuspect,
                    ...formDataWsa,
                },
    ...
    function setWsa(idProspek, form_data_fu) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanDataWsa",
            data: {
    ...
    function setFu(idProspek, form_data_fu) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanDataFolloup",
            data: form_data_fu,
            dataType: "json",
            success: function(data) {
                if (data.status === true) {
    ...
    function setFuWsa(idProspek) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanFollowupForWsa",
            data: {
    ...
    $(document).on('click', '#btn_test_drive_suspect', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getCekDataProspekIdWsa",
            data: {
                id_prospek: id_prospek,
            },
            dataType: "json",
    ...
    function getTypeUnit() {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataType",
            // data: "data",
            dataType: "json",
            success: function(data) {
    ...
    function getVarianUnit(id_type) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataVarian",
            data: {
                id_type: id_type,
            },
            dataType: "json",
    ...
    $(document).on('click', '#btn_simpan_test_drive', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanTestDrive",
            data: {
                ...formTestDrive,
                status_customer: status_customer,
            },
    ...
    function setTestDrvieWsa(id_prospek) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanTestDriveWsa",
            data: {
                id_prospek: id_prospek
            },
            dataType: "json",
    ...
    function getProspek(id_prospek) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataProspek",
            data: {
                id_prospek: id_prospek,
            },
            dataType: "json",
    ...
    function getMediaMotivator(id_media) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataMediaMotivaor",
            data: {
                id_media: id_media,
            },
            dataType: "json",
    ...
    function cekStokUnit(kode_unit) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataStockUnit",
            data: {
                kode_unit: kode_unit,
            },
            dataType: "json",
    ...
    $(document).on('click', '#btn_simpan_prospek', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanProspek",
            data: prospek,
            dataType: "json",
            success: function(data) {
                if (data.status === true) {
    ...
    function getHotProspek(id_prospek) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataHotProspek",
            data: {
                id_prospek: id_prospek
            },
            dataType: "json",
    ...
    $(document).on('click', '#btn_simpan_hot_prospek', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanHotProspek",
            data: hotProspek,
            dataType: "json",
            success: function(data) {
                if (data.status === true) {
    ...
    function getSpk(id_prospek) {
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataSpk",
            data: {
                id_prospek: id_prospek,
            },
            dataType: "json",
    ...
    function getNoSpk(no_spk) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataNoSpk",
            data: {
                no_spk: no_spk,
            },
            dataType: "json",
    ...
    function getLeasing(id_leasing) {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/getDataLeasing",
            data: {
    ...
    $(document).on('change', '#upload_foto', function(e) {
        ...
        if (files.length > 0) {
            ...
            if (file >= 1024) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanFotoPayment",
                    data: form_data,
                    cache: false,
                    contentType: false,
                    processData: false,
    ...
    $(document).on('click', '#btn_simpan_spk', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?= base_url() ?>sales_jadwal_kunjungan/simpanSpk",
            data: spk,
            dataType: "json",
            success: function(data) {
                if (data.status === true) {
