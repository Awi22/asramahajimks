                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="FotoProfil" role="tabpanel">
                                <div class="card-body p-10 pt-5">
                                    <form action="<?= base_url('profil/upload_foto_asn') ?>" id="formFotoASN" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row fv-row mb-5">
                                                        ...
                                                        <div class="input-group-sm col-sm-8">
                                                            <input type="text" class="form-control form-control-sm" placeholder="Nama Lengkap" name="nama_pegawai" id="nama_pegawai" autocomplete="off" disabled readonly />
                                                        </div>
                                                    </div>
                                                    <div class="row fv-row mb-5">
                                                        <label class="required col-sm-4 col-form-label">NIP</label>
                                                        <div class="input-group-sm col-sm-8">
                                                            <input type="text" class="form-control form-control-sm" placeholder="NIP" name="nip" id="nip" autocomplete="off" disabled readonly />
                                                        </div>
                                                    </div>
                                                    <div class="row fv-row mb-5">
                                                        <label class="required col-sm-4 col-form-label">Jenis ASN</label>
                                                        <div class="input-group-sm col-sm-8">
                                                            <input type="text" class="form-control form-control-sm" placeholder="Jenis ASN" name="jenis_asn" id="jenis_asn" autocomplete="off" disabled readonly />
                                                        </div>
                                                    </div>
                                                    <div class="row fv-row mb-5">
