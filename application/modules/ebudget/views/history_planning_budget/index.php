				...
				<!-- <div class="d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper"> -->
					...
					<div class="col-md-6">
						<div class="col">
							...
							<div class="fv-row mb-5">
								...
								<div class="form-check mb-5 mx-12">
									<input class="form-check-input" type="radio" name="set_biaya" id="average_tahunlalu" value="">
									<label class="form-check-label" for="biaya_otomatis">
					...
					<div class="fv-row mb-5">
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="januari">
									</div>
								</div>
								...
								<div class=" form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="februari">
									</div>
								</div>
								...
								<div class=" form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="maret">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="april">
									</div>
								</div>
								...
								<div class=" form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="mei">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="juni">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="juli">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="agustus">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="september">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="oktober">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="november">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="desember">
									</div>
								</div>
							</div>
