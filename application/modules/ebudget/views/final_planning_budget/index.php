				...
				<!-- <div class="d-flex flex-column flex-xl-row flex-row-fluid" id="kt_modal_create_app_stepper"> -->
					...
					<div class="fv-row mb-5">
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="januari" id="januari">
									</div>
								</div>
								...
								<div class=" form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="februari" id="februari">
									</div>
								</div>
								...
								<div class=" form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="maret" id="maret">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="april" id= "april">
									</div>
								</div>
								...
								<div class=" form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="mei" id="mei">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="juni" id="juni">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="juli" id="juli">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="agustus" id="agustus">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="september" id="september">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="oktober" id="oktober">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="november" id="november">
									</div>
								</div>
								...
								<div class="form-months row mb-3">
									...
									<div class="col-9">
									<input type="text" class="form-control form-control-sm inputan_bulan" placeholder="" name="desember" id="desember">
									</div>
								</div>
							</div>
