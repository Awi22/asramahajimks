    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="#" class="btn btn-sm fw-bold btn-primary btn-tambah" data-bs-toggle="modal" data-bs-target="#modal_tambah_gedung">Tambah</a>
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="card">
                <div class="card-body py-4">
                    <div class="table-responsive">
                        <table id="table_gedung" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
...
<!--start::MODALS-->
<!-- start::modal_tambah_gedung -->
<div class="modal fade" id="modal_tambah_gedung" tabindex="-1" aria-hidden="true">
