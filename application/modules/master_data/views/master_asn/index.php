    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                <a href="#" class="btn btn-sm fw-bold btn-primary btn-tambah" data-bs-toggle="modal" data-bs-target="#modal_tambah_pegawai">Tambah</a>
            </div>
            <!--end::Actions-->
        </div>
            ...
            <div class="card">
                <div class="card-body py-4">
                    <div class="table-responsive">
                        <table id="table_pegawai" class="table align-middle table-row-dashed fs-6 gy-5">
                            <thead>
...
<!--start::MODALS-->
<!-- Model Tambah Pegawai -->
<div class="modal fade" id="modal_tambah_pegawai" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="col-md-12">
                        <div class="row fv-row mb-5">
                            ...
                            <div class="input-group-sm col-sm-8">
                                <input type="text" class="form-control form-control-sm" placeholder="Nama Lengkap" name="nama_pegawai" id="nama_pegawai" autocomplete="off" />
                            </div>
                        </div>
                        <div class="row fv-row mb-5">
                            <label class="required col-sm-4 col-form-label">NIP</label>
                            <div class="input-group-sm col-sm-8">
                                <input type="text" class="form-control form-control-sm" placeholder="NIP" name="nip" id="nip" autocomplete="off" />
                            </div>
                        </div>
                        <div class="row fv-row mb-5">
                            <label class="required col-sm-4 col-form-label">Jenis ASN</label>
                            <div class="input-group-sm col-sm-8">
                                <select class="form-select form-select-sm" data-placeholder="Pilih Jenis ASN" id="opt_id_jenis_asn" name="opt_id_jenis_asn">
                                    <option value=""></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="fw-bold fs-3 rotate collapsible mb-7 mt-7" data-bs-toggle="collapse" href="#modal_tambah_pegawai_lanjutan" role="button" aria-expanded="false" aria-controls="modal_tambah_pegawai_detail">
                            <h3 class="text-gray-700"><span>Detail Pegawai</span></h3>
                            <span class="ms-2 rotate-180">
                                <i class="ki-duotone ki-down fs-3"></i>
                            </span>
                        </div>
                        <div id="modal_tambah_pegawai_lanjutan" class="collapse show">
