	...
	<div id="kt_app_toolbar" class="app-toolbar py-3">
		<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
			...
			<div class="d-flex align-items-center gap-2 gap-lg-3">
				<a href="#" class="btn btn-sm fw-bold btn-primary btn-tambah" data-bs-toggle="modal" data-bs-target="#modal_upload">Upload</a>
			</div>
		</div>
	</div>
	<!--end::Toolbar-->
					...
					<div class="card mb-5 mb-xl-8">
						...
						<div class="card-header justify-content-start gap-6 p-6">
							...
							<div class="mb-2 col-12 col-sm-3">
								...
								<select name="opt_cabang" id="opt_cabang" class="form-select form-select-sm" data-control="select2" data-hide-search="true" data-placeholder="-- SEMUA CABANG --">
									<option value=""></option>
								</select>
							</div>
						</div> 
			...
			<div class="modal-body">
				<div class="row">
					<div class="col">
						...
						<div class="fv-row mb-2 form-group row">
							<label class="required fs-6 mb-2 col-md-4" for="modal_opt_key_kategori">Key Kategori</label>
							<div class=" mb-2 col-md-8">
								<select name="modal_opt_key_kategori" id="modal_opt_key_kategori" class="form-select form-select-sm" data-control="select2" data-hide-search="true" data-placeholder="-- PILIH KATEGORI --">
									<option value=""></option>
								</select>
							</div>
						</div>
						<div class="fv-row mb-2 form-group row">
							...
							<div class="mb-2 col-md-8">
								...
								<div class="row mt-2">
									<a href="<?= base_url('public/upload/excel/kpi-as/kpi-target.xlsx') ?>" class="fw-bold text-end" download>Download Template</a>
								</div>
							</div>
						</div>
