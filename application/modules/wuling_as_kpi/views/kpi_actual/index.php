					...
					<div class="col">
						...
						<div class="fv-row mb-2 form-group row">
							...
							<div class="mb-2 col-md-8">
								...
								<div class="row mt-2">
									<a href="<?= base_url('public/upload/excel/kpi-as/kpi-actual.xlsx') ?>" class="fw-bold text-end" download>Download Template</a>
								</div>
							</div>
						</div>
...
<!-- start::modal_sinkron -->
<div class="modal fade" id="modal_sinkron" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header px-5 py-5">
				<h5 class="text-gray-700 m-0"><span class="judul-modal">Sinkron Data</span></h5>
				<div class="btn btn-sm btn-icon btn-active-color-primary fs-10" data-bs-dismiss="modal">
					<i class="bi bi-x fs-1"></i>
				</div>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col">
						<div class="fv-row mb-2 form-group row">
							<label class="required fs-6 mb-2 col-md-4" for="modal_opt_tahun_sinkron">Tahun</label>
							<div class=" mb-2 col-md-8">
								<select name="modal_opt_tahun_sinkron" id="modal_opt_tahun_sinkron" class="form-select form-select-sm" data-control="select2" data-hide-search="true">
								</select>
							</div>
						</div>
						<div class="fv-row mb-2 form-group row">
							<label class="required fs-6 mb-2 col-md-4" for="modal_opt_bulan_sinkron">Bulan</label>
							<div class=" mb-2 col-md-8">
								<select name="modal_opt_bulan_sinkron" id="modal_opt_bulan_sinkron" class="form-select form-select-sm" data-control="select2" data-hide-search="true">
								</select>
							</div>
						</div>
					</div>
			...
			<div class="modal-footer flex-end m-0 p-0 px-5 py-5">
				<button id="btn-sinkron" class="btn btn-sm btn-primary">
					<span class="indicator-label">Sinkron</span>
					<span class="indicator-progress">Menyinkron...
						<span class="spinner-border spinner-border-sm align-middle ms-2"></span>
					</span>
				</button>
			</div>
