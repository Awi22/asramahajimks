		...
		<div id="kt_app_content_container" class="app-container container-fluid">
			...
			<div class="card">
				...
				<div class="card-header justify-content-start gap-6 p-6">
					...
					<div class="mb-2 col-md-2">
						<label class="form-label fw-bold fs-6 text-gray-700">Group Pelanggan</label>
						<select name="opt_group_pelanggan" id="opt_group_pelanggan" class="form-select form-select-sm" data-control="select2" data-hide-search="true" data-placeholder="-- SEMUA --" data-allow-clear="true">
							<option value=""></option>
						</select>
					</div>
					<div class="mb-2 col-md-2">
