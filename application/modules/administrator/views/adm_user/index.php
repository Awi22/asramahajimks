			...
			<div class="card">
				...
				<div class="card-header justify-content-start gap-6 p-6">
					<div class="mb-2 col-12 col-sm-3">
						<label class="form-label fw-bold fs-6 text-gray-700">Status Pegawai</label>
						<select name="opt_status_pegawai" id="opt_status_pegawai" class="form-select form-select-sm">
							<option value=""></option>
						</select>
					</div>
					<div class="mb-2 col-12 col-sm-3">
						<label class="form-label fw-bold fs-6 text-gray-700">Status Aktif</label>
					...
					<div class="col-md-6">
						...
						<div class="col">
							<div class="fv-row mb-5">
								<label class="required fs-6 mb-1">Status Pegawai</label>
								<select class="form-select form-select-sm" name="user_opt_status_pegawai" id="user_opt_status_pegawai">
									<option value=""></option>
								</select>
							</div>
							<div class="fv-row mb-5">
								<label class="required fs-6 mb-1">NIP / Kode Karyawan</label>
								<div class="input-group input-group-sm mb-5">
									<input type="text" class="form-control form-control-sm" id="user_nip_kk" readonly />
...
<!-- start::modal_cari_asn -->
<div class="modal fade" id="modal_cari_asn" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered mw-900px">
		<div class="modal-content">
			<div class="modal-header p-5">
				<h3 class="text-gray-700">ASN</h3>
				<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
					<i class="bi bi-x fs-1"></i>
				</div>
			</div>
			<div class="modal-body">
				<table id="table_asn" class="table table-striped table-row-bordered gy-2 gs-2">
					<thead>
...
<!-- start::modal_cari_karyawan -->
<div class="modal fade" id="modal_cari_karyawan" tabindex="-1" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered mw-900px">
		<div class="modal-content">
			<div class="modal-header p-5">
				<h3 class="text-gray-700">Karyawan</h3>
				<div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
					<i class="bi bi-x fs-1"></i>
				</div>
			</div>
			<div class="modal-body">
				<table id="table_karyawan" class="table table-striped table-row-bordered gy-2 gs-2">
					<thead>
						<tr class="fw-semibold fs-6 text-gray-700">
							<th>NIK</th>
							<th>Cabang</th>
