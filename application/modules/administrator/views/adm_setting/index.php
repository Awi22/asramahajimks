					...
					<div class="card mb-5 mb-xl-8">
						<div class="card-title border p-5">
							<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
								<li class="nav-item">
									<a class="nav-link text-active-primary py-5 me-6 active" href="<?= base_url('adm_setting') ?>">Background Images</a>
								</li>
								<li class="nav-item">
						...
						<div class="card-body p-10 pt-5">
							...
							<form action="<?= base_url('adm_setting/upload_background') ?>" id="formUpload" enctype="multipart/form-data" method="post" accept-charset="utf-8">
