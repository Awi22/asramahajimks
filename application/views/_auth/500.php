...
<head>
	...
	<title>System Error - Portal Asrama Haji Makassar</title>
	<meta charset="utf-8" />
...
<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
	...
	<div class="d-flex flex-column flex-root" id="kt_app_root">
		...
		<style>
			body {
				background-image: url('<?= base_url('public/assets/') ?>media/auth/bg7.jpg');
			}

			[data-bs-theme="dark"] body {
				background-image: url('<?= base_url('public/assets/') ?>media/auth/bg7-dark.jpg');
			}
		</style>
		<!--end::Page bg image-->
