...
<html lang="en">
	<head>
		...
		<title>Blocked - DMS Wuling</title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<style>body { background-image: url('<?= base_url('public/assets/') ?>media/auth/bg3.jpg'); } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg3-dark.jpg'); }</style>
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<br />atau Anda mengakses menu yang salah!</div>
							<!--end::Text-->
							<!--begin::Link-->
							<div class="mb-11">
